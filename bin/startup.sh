...
sleep 5
rm -rf server*.pid
play start -Xms512M -Xmx6144M -XX:+UnlockDiagnosticVMOptions $_commercial -XX:+UseAES -XX:+UseAESIntrinsics -XX:+UseStringDeduplication -XX:+HeapDumpOnOutOfMemoryError -XX:MaxMetaspaceSize=1g -XX:+AlwaysPreTouch -javaagent:bin/lombok.jar
